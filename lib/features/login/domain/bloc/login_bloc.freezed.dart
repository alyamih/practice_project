...
class __$$AuthedImplCopyWithImpl<$Res>
    extends _$LoginStateCopyWithImpl<$Res, _$AuthedImpl>
...
class _$AuthedImpl implements _Authed {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$AuthedImpl);
  }
...
abstract class _Authed implements LoginState {
  const factory _Authed() = _$AuthedImpl;
}
...
class _$ErrorImpl implements _Error {
  const _$ErrorImpl({required this.message, this.error, this.stackTrace});
  ...
  @override
  String toString() {
    return 'LoginState.error(message: $message, error: $error, stackTrace: $stackTrace)';
  }
